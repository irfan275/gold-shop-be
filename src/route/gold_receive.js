...
const {createInvoice,getInvoices,getInvoiceById,deleteInvoice,updateInvoice, getInvoicesByFilter, getInvoiceNumber}= require('../controller/gold_receive.controller')
